            ...
            <Box py={4}>
                <VStack spacing={2} textAlign="center">
                    <Heading as="h1" fontSize="4xl">
                        Lost your premium? Renew at zero cost!
                    </Heading>
                ...
                <Container pt={12} maxW={'container.sm'}>
                    <FormControl>
                        <form onSubmit={e => handleSubmit(e)}>
                            ...
                            <FormLabel pt={2}>New Spotify Email</FormLabel>
                            ...
                            <Select placeholder='Select country' pb={5} onChange={e => setCountry(e.target.value)}>
                                {countries.map((country) => {
                                    return <option value={getCountryCode(country)}>{country}</option>;
                                })}
                            </Select>
                            <Button colorScheme='green' variant='outline' type="submit" width={'full'} rightIcon={<ArrowForwardIcon />} loadingText="Renewing account" isLoading={isLoading}>
                                Renew account
                            </Button>
                        </form>
                    </FormControl>
