...
import {
  ...
  require_prop_types
} from "./chunk-3ESVFFDF.js";
import {
  _extends
} from "./chunk-NTSSWPHQ.js";
import {
  __commonJS,
  __esm,
  __export,
...
function useHighlight(props) {
  ...
  return (0, import_react124.useMemo)(() => highlightWords({ text, query: query2 }), [text, query2]);
}
...
function Hide(props) {
  ...
  return (0, import_jsx_runtime91.jsx)(Visibility, { breakpoint: query2, hide: true, ssr, children });
}
...
function Show(props) {
  const { children, ssr } = props;
  const query2 = useQuery(props);
  return (0, import_jsx_runtime92.jsx)(Visibility, { breakpoint: query2, ssr, children });
}
